...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove"
                    CommandArgument='<%# Eval("ProductId") %>' OnClientClick="return confirm('Do you want to remove this item from your cart ?');">
    ...
    <FooterTemplate>
        </tbody> <!-- Closing tbody here to properly structure the table -->
        <tr>
            <td colspan="3"></td>
        ...
        </table> <!-- Properly closing the table here -->
    </FooterTemplate>
</asp:Repeater>
